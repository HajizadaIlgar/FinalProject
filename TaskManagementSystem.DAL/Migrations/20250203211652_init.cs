        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImagerlUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserTaskItem", x => new { x.TasksId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_AppUserTaskItem_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserTaskItem_TaskItems_TasksId",
                        column: x => x.TasksId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserTaskItem_UsersId",
